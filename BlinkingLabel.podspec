...
#TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/bel0c0/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'bel0c0' => 'blaw@diligent.com' }
  s.source           = { :git => 'https://github.com/bel0c0/BlinkingLabel.git', :tag => s.version.to_s }
